...
BUTTON_CODE_MAP_T button_code_map[] = {
    {"btn_up", TDL_BUTTON_PRESS_SINGLE_CLICK, KEY_UP},     {"btn_down", TDL_BUTTON_PRESS_SINGLE_CLICK, KEY_DOWN},
    {"btn_left", TDL_BUTTON_PRESS_SINGLE_CLICK, KEY_LEFT}, {"btn_right", TDL_BUTTON_PRESS_SINGLE_CLICK, KEY_RIGHT},
    {"btn_up", TDL_BUTTON_LONG_PRESS_START, KEY_ENTER},    {"btn_down", TDL_BUTTON_LONG_PRESS_START, KEY_ESC},
